            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="mx-auto max-w-5xl">
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {/* Card 1: Privacy */}
                        <div className="flex flex-col items-center text-center bg-card p-8 rounded-2xl shadow-sm ring-1 ring-border">
                        ...
                        {/* Card 3: Control */}
                        <div className="flex flex-col items-center text-center bg-card p-8 rounded-2xl shadow-sm ring-1 ring-border sm:col-span-2 lg:col-span-1">
                            <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-primary/10 mb-4">
