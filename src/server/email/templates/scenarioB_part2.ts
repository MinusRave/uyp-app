...
Unlock The Answer (~~$197~~ $29) → ${vars.app_url}/results?session=${vars.session_id}
...
Get Your Report (~~$197~~ $29) → ${vars.app_url}/results?session=${vars.session_id}
...
Get The Translator (~~$197~~ $29) → ${vars.app_url}/results?session=${vars.session_id}
