...
Unlock Your Report (~~$197~~ $29) → ${vars.app_url}/results?session=${vars.session_id}
...
Finish Your Purchase (~~$197~~ $29) → ${vars.app_url}/results?session=${vars.session_id}
...
Unlock Your Results Now (~~$197~~ $29) → ${vars.app_url}/results?session=${vars.session_id}
